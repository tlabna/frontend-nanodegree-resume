...
var bio = {
  ...
  welcomeMessage:
    "Welcome to my Resume! Here you'll get to know a little about me and my past experiences. If you wish to get in conact with me, don't hesitate to get in touch.",
  skills: [
    "HTML",
    "CSS",
    "JS/ES6",
  ...
  display: function() {
    ...
    var formattedFirstName = HTMLheaderFName.replace(
      "%data%",
      splitNames[0].toUpperCase()
    );
    var formattedLastName = HTMLheaderLName.replace(
      "%data%",
      splitNames[1].toUpperCase()
    );
    ...
    for (var contact in bio.contacts) {
      if (bio.contacts.hasOwnProperty(contact)) {
        if (contact == "mobile") {
          ...
          formattedLinkedIn = HTMLlinkedin.replace(
            "%data%",
    ...
    var contactArray = [];
    contactArray.push(
      /*formattedMobile, formattedEmail,*/ formattedGitHub,
      formattedLinkedIn,
      formattedLocation
    );
...
var education = {
  ...
  display: function() {
    ...
    for (
      var onlineCourse = 0;
      onlineCourse < education.onlineCourses.length;
      onlineCourse++
    ) {
      $("#education").append(HTMLschoolStart);
  ...
  projects: [
    {
      ...
      dates: "July 2018",
      description: "A full stack restaurant application where users can search, geolocate, review and add/edit their favourite restaurants from around the world.",
      technologies: [
        "Node",
        "Express",
        "mongoDB",
    ...
    for (var project = 0; project < projects.projects.length; project++) {
      ...
      if (currentProject.technologies.length > 0) {
        ...
        for (var tech = 0; tech < currentProject.technologies.length; tech++) {
          var formattedTechnology = HTMLprojectTechnology.replace(
            "%data%",
      ...
      if (currentProject.github !== "") {
        var formattedGithub = HTMLprojectGithub.replace(
          "#",
...
var languages = {
  ...
  display: function() {
    ...
    for (var language = 0; language < languages.languages.length; language++) {
      ...
      var formattedLanguageName = HTMLlanguageName.replace(
        "%data%",
      ...
      if (currentLanguage.level == 3) {
        ...
        console.log(
          "Something isn't right....Didn't find a number for language level"
        );
      }
    }
  }
...
var distinctions = {
  ...
  display: function() {
    ...
    for (
      var distinction = 0;
      distinction < distinctions.distinctions.length;
      distinction++
    ) {
      var currentDistinction = distinctions.distinctions[distinction];

      var formattedDistinction = HTMLdistinction.replace(
        "%data%",
        currentDistinction
      );
...
function checkSize() {
  ...
  //Remove centering if window is resized back to a larger screen
    ...
    $(".topContactsBox").css("float") === "right" &&
    $(".topContactsBox")
      .parent()
